...
#### 64비트
[여기](https://www.youtube.com/watch?v=cJI6utFsFr4)에 접속하면 설명 창에 구글 드라이브 링크가 있는데 접속하여 화일들을 내려받는다. DLL 화일들을 SYSTEM32에 붙여넣는다. (본인 책임하에 사용하기, 시스템 복원 지점 생성 권장) 재시동 후 Node.js 6 설치를 시도해보자.
