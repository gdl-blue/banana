		...
		<form method=post>
			<div class=vertical-tabs>
				<div class=tab-list style="display: none;">
					<div class=vertical-tab data-paneid=general>일반</div>
					<div class=vertical-tab data-paneid=notices>공지와 알림</div>
					...
					<div class=vertical-tab data-paneid=email>우편 인증</div>
					<div class=vertical-tab data-paneid=filters>필터</div>
					<div class=vertical-tab data-paneid=api>봇과 API</div>
					<div class=vertical-tab data-paneid=misc>고급</div>
